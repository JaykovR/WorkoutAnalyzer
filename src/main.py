...
class main:
        def __init__(self):
            ...
            ## Button executes display_data
            self.button = tk.Button(self.root, text = "Display Data", font=('Arial', 15), width= 20, height = 10, command=display_data)
